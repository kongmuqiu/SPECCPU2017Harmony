...
**Kirin 9030P (14 核, Mate 80 RS)**

| 核心编号 | 微架构 | MIDR Part | 角色 | cpuset/top-app |
|----------|--------|-----------|------|----------------|
| 0-3 | Cortex-A520 | 0xd24 | 小核 (LITTLE) | 在集合内 |
| 4-11 | Cortex-A720 | 0xd47 | 大核 (big) | 0-8 在集合内, 9-11 不确定 |
| 12-13 | Cortex-X5 | 0xd06 | 超大核 (X) | 不在集合内 |
